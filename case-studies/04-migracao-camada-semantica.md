...
**Setor:** Corporativo de grande porte — energia (óleo e gás), ecossistema SAP + Oracle
**Empregador:** Dataside (consultoria)
**Papel:** Engenheiro de Dados Sênior — ponto focal técnico
**Continuação:** [Case 07](07-virtualizacao-sap-datasphere-databricks.md) documenta a virtualização do SAP Datasphere em Azure Databricks no mesmo ambiente (2026)
...
## Evolução em 2026: do Datasphere ao Databricks

Em 2026 a frente ganhou duas demandas novas no mesmo ecossistema, ambas documentadas no [Case 07](07-virtualizacao-sap-datasphere-databricks.md):

- **View curada em SAP Datasphere** para confirmações de operação de manutenção industrial, com cerca de 50 campos de origem mapeados para o padrão de nomenclatura do Data Product. O método de "registro Rosetta" (uma chave de negócio cujos valores desambiguam colunas homônimas) produziu 34 correspondências e evitou 4 erros de transcrição ao insistir no DDL real em vez de screenshots.
- **Virtualização do Datasphere em Azure Databricks** via Lakehouse Federation, com view de consumo filtrada por segmento, job multi-task Serverless e promoção por esteira Azure DevOps em três ambientes. Em produção desde setembro de 2026.
