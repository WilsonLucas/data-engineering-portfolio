...
PAGES = [
    ...
    (
        ...
        ("../index.html#cases", "Voltar ao portfolio"),
        ("04-migracao-camada-semantica.html", "← Case 04 · Migração Camada Semântica"),
        ("06-migracao-synapse-gcp-lakehouse.html", "Case 06 · Migração Synapse → GCP →"),
    ),
    (
        "case-studies/06-migracao-synapse-gcp-lakehouse.md",
        "case-studies/06-migracao-synapse-gcp-lakehouse.html",
        "Case 06 · Migração de Lakehouse Azure Synapse para Google Cloud",
        "Case Study 06 · Setor Público · Google Cloud",
        ("../index.html#cases", "Voltar ao portfolio"),
        ("05-medallion-databricks-free-edition.html", "← Case 05 · Medallion Free Edition"),
        ("07-virtualizacao-sap-datasphere-databricks.html", "Case 07 · SAP Datasphere → Databricks →"),
    ),
    (
        "case-studies/07-virtualizacao-sap-datasphere-databricks.md",
        "case-studies/07-virtualizacao-sap-datasphere-databricks.html",
        "Case 07 · Virtualização de SAP Datasphere em Azure Databricks",
        "Case Study 07 · Energia · Lakehouse Federation",
        ("../index.html#cases", "Voltar ao portfolio"),
        ("06-migracao-synapse-gcp-lakehouse.html", "← Case 06 · Migração Synapse → GCP"),
        ("08-finops-azure-otimizacao-custos.html", "Case 08 · FinOps Azure →"),
    ),
    (
        "case-studies/08-finops-azure-otimizacao-custos.md",
        "case-studies/08-finops-azure-otimizacao-custos.html",
        "Case 08 · FinOps em Azure · Otimização de Custos",
        "Case Study 08 · Energia · FinOps",
        ("../index.html#cases", "Voltar ao portfolio"),
        ("07-virtualizacao-sap-datasphere-databricks.html", "← Case 07 · SAP Datasphere → Databricks"),
        ("09-validacao-paridade-knime-pyspark.html", "Case 09 · Validação KNIME → PySpark →"),
    ),
    (
        "case-studies/09-validacao-paridade-knime-pyspark.md",
        "case-studies/09-validacao-paridade-knime-pyspark.html",
        "Case 09 · Validação de Paridade KNIME → Databricks",
        "Case Study 09 · Bens de Consumo · Validação",
        ("../index.html#cases", "Voltar ao portfolio"),
        ("08-finops-azure-otimizacao-custos.html", "← Case 08 · FinOps Azure"),
        None,
    ),
